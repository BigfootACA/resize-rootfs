...
extern string FormatSize(uint64_t val,const char**units=size_units_ib,size_t blk=1024);
extern string FormatSizeFloat(uint64_t val,const char**units=size_units_ib,size_t blk=1024,uint8_t dot=2);
extern string FormatSizeHz(uint64_t val);
extern string FormatSizeFloatHz(uint64_t val,uint8_t dot);
extern string SizeString(uint64_t val);
extern string SizeStringFloat(uint64_t val);
#endif
